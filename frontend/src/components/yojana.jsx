      ...
      <div className="max-w-7xl mx-auto px-2 xs:px-3 sm:px-4">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 xs:gap-7 sm:gap-8 relative z-10">
            ...
            <div className="text-center px-2">
              <div className={`bg-gradient-to-br from-yellow-100 to-yellow-200 w-12 h-12 xs:w-14 xs:h-14 sm:w-16 sm:h-16 rounded-lg sm:rounded-xl flex items-center justify-center mx-auto mb-2 xs:mb-3 sm:mb-4 border sm:border-2 border-yellow-300/50 transition-all duration-500 ${
                isVisible ? 'animate-pulse' : ''
              }`} style={{boxShadow: window.innerWidth < 640 ? 'inset 0 1px 0 rgba(255,255,255,0.7), 0 4px 8px rgba(250, 204, 21, 0.25)' : window.innerWidth < 768 ? 'inset 0 1px 0 rgba(255,255,255,0.75), 0 5px 10px rgba(250, 204, 21, 0.275)' : 'inset 0 1px 0 rgba(255,255,255,0.8), inset 0 -1px 0 rgba(0,0,0,0.1), 0 6px 12px rgba(250, 204, 21, 0.3), 0 2px 4px rgba(0,0,0,0.15)'}}>
                <svg className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8 text-yellow-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{filter: 'drop-shadow(0 2px 2px rgba(0,0,0,0.2)'}}>
            ...
            {/* Step 2 */}
            <div className="text-center px-2">
              <div className={`bg-gradient-to-br from-yellow-100 to-yellow-200 w-12 h-12 xs:w-14 xs:h-14 sm:w-16 sm:h-16 rounded-lg sm:rounded-xl flex items-center justify-center mx-auto mb-2 xs:mb-3 sm:mb-4 border sm:border-2 border-yellow-300/50 transition-all duration-500 delay-1000 ${
                isVisible ? 'animate-pulse' : ''
              }`} style={{boxShadow: window.innerWidth < 640 ? 'inset 0 1px 0 rgba(255,255,255,0.7), 0 4px 8px rgba(250, 204, 21, 0.25)' : window.innerWidth < 768 ? 'inset 0 1px 0 rgba(255,255,255,0.75), 0 5px 10px rgba(250, 204, 21, 0.275)' : 'inset 0 1px 0 rgba(255,255,255,0.8), inset 0 -1px 0 rgba(0,0,0,0.1), 0 6px 12px rgba(250, 204, 21, 0.3), 0 2px 4px rgba(0,0,0,0.15)'}}>
                <svg className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8 text-yellow-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{filter: 'drop-shadow(0 2px 2px rgba(0,0,0,0.2)'}}>
            ...
            {/* Step 3 */}
            <div className="text-center px-2">
              <div className={`bg-gradient-to-br from-yellow-100 to-yellow-200 w-12 h-12 xs:w-14 xs:h-14 sm:w-16 sm:h-16 rounded-lg sm:rounded-xl flex items-center justify-center mx-auto mb-2 xs:mb-3 sm:mb-4 border sm:border-2 border-yellow-300/50 transition-all duration-500 delay-2000 ${
                isVisible ? 'animate-pulse' : ''
              }`} style={{boxShadow: window.innerWidth < 640 ? 'inset 0 1px 0 rgba(255,255,255,0.7), 0 4px 8px rgba(250, 204, 21, 0.25)' : window.innerWidth < 768 ? 'inset 0 1px 0 rgba(255,255,255,0.75), 0 5px 10px rgba(250, 204, 21, 0.275)' : 'inset 0 1px 0 rgba(255,255,255,0.8), inset 0 -1px 0 rgba(0,0,0,0.1), 0 6px 12px rgba(250, 204, 21, 0.3), 0 2px 4px rgba(0,0,0,0.15)'}}>
                <svg className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8 text-yellow-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{filter: 'drop-shadow(0 2px 2px rgba(0,0,0,0.2)'}}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-5 xs:gap-6 sm:gap-7 md:gap-8">
          {yojanas.map((yojana, index) => (
            <div 
              key={yojana.id}
              className={`bg-white/25 rounded-xl sm:rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-500 hover:scale-105 border sm:border-2 border-gray-200/50 ${
                isVisible 
                  ? 'opacity-100 translate-y-0' 
                  : 'opacity-0 translate-y-20'
              }`}
              style={{boxShadow: window.innerWidth < 640 ? 'inset 0 1px 0 0 rgba(255,255,255,0.8), 0 10px 20px -8px rgba(0,0,0,0.08)' : window.innerWidth < 768 ? 'inset 0 1px 0 0 rgba(255,255,255,0.85), 0 15px 30px -10px rgba(0,0,0,0.09)' : 'inset 0 1px 0 0 rgba(255,255,255,0.9), inset 0 -1px 0 0 rgba(0,0,0,0.05), 0 20px 40px -12px rgba(0,0,0,0.1), 0 4px 6px -1px rgba(0,0,0,0.05)'}}>
              {/* Card Header */}
