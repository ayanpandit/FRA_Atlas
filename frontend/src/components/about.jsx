				...
				<div className="grid grid-cols-1 lg:grid-cols-[58%_42%] gap-6 xs:gap-8 sm:gap-10 md:gap-12 lg:gap-10 xl:gap-14 2xl:gap-16 items-start">
					<div className="order-2 lg:order-1 w-full space-y-6 xs:space-y-8 sm:space-y-10 md:space-y-12">
						<div className="group w-full">
							<div className="relative overflow-hidden rounded-xl sm:rounded-2xl transition-transform duration-500 hover:scale-[1.02] w-full border sm:border-2 border-gray-200/50" style={{boxShadow: window.innerWidth < 640 ? 'inset 0 1px 0 0 rgba(255,255,255,0.8), 0 10px 20px -8px rgba(0,0,0,0.12)' : window.innerWidth < 768 ? 'inset 0 1px 0 0 rgba(255,255,255,0.85), 0 15px 30px -10px rgba(0,0,0,0.13)' : 'inset 0 1px 0 0 rgba(255,255,255,0.9), inset 0 -1px 0 0 rgba(0,0,0,0.05), 0 20px 40px -12px rgba(0,0,0,0.15), 0 4px 6px -1px rgba(0,0,0,0.1)'}}>
					...
					<div className="order-1 lg:order-2 flex flex-col justify-between">
						<div className="flex flex-col">
							...
							<div className="space-y-6 xs:space-y-7 sm:space-y-8 md:space-y-9 lg:space-y-6 xl:space-y-7 2xl:space-y-8">
								<div className="relative pl-4 sm:pl-5 border-l-2 sm:border-l-4 border-yellow-500" style={{boxShadow: window.innerWidth < 640 ? '-1px 0 2px rgba(250, 204, 21, 0.25)' : '-2px 0 4px rgba(250, 204, 21, 0.3)'}}>
