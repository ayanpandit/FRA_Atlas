        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            ...
            <div className="space-y-1">
              <div className="grid grid-cols-2 gap-2 text-xs text-gray-500 uppercase tracking-wider pb-2 border-b border-gray-100">
                <span>Status</span>
                <span>ID</span>
              </div>
              {isLoadingMetrics ? (
                Array.from({ length: 4 }).map((_, index) => (
                  <div key={`skeleton-${index}`} className="grid grid-cols-3 gap-2 py-2 text-sm items-center animate-pulse">
                ...
                recentApplications.map((application) => (
                  <div key={application.id} className="grid grid-cols-3 gap-2 py-2 text-sm items-center">
